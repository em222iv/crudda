	    ...
	    <nav class="orange">
	        <div class="nav-wrapper container">
	            ...
	            <ul class="right hide-on-med-and-down">
	                <li><a  href="/index.php?page_id=4" class="modal-trigger"><i class="mdi-action-perm-identity"></i></a></li>
	                <!-- <li><a href="#"><i class="mdi-image-photo"></i></a></li>
	            ...
	            <ul class="side-nav" id="mobile-demo">
	                <li>
	                  ...
	                  <li>
											<a  href="/index.php?page_id=4" class="modal-trigger"><i class="mdi-action-perm-identity"></i></a>
										</li>
	            </ul>
	        </div>
	    </nav>
