<footer class="page-footer orange">
      <div class="container">
        <div class="row">
          <div class="col l4 s12">
            <?php if ( function_exists('dynamic_sidebar') && dynamic_sidebar('Left-Footer-Area') ) : else : ?>
                  <h5 class="white-text"><?php echo the_widget( 'WP_Widget_Text', "title", $args ); ?>
</h5>
            ...
            <?php endif; ?>
              <form id="paypal-donate" action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
							...
							">
							<button class="btn waves-effect waves-light orange lighten-3" type="submit" name="action" alt="PayPal - The safer, easier way to pay online!">Donate Now
							</button>
						</form>
          </div>
          <div class="col l4 s12">
            <h5 class="white-text">Någon annan sorts text</h5>
            ...
            <a class="btn waves-effect orange lighten-3" target="_blank" href="https://gitter.im/Dogfalo/materialize">Chat</a>
          </div>
      ...
      <div class="footer-copyright">
        <div class="container">
        © 2016 - Fru Magnusson
        <a class="grey-text text-lighten-4 right" href="https://github.com/Dogfalo/materialize/blob/master/LICENSE">Birgitta Magnusson</a>
        </div>
      </div>
  </footer>
	...
	<!-- analytics -->
	<?php wp_footer(); ?>
	<script type="text/javascript" src="<?php bloginfo('template_url'); ?>/javascript/materialize.min.js"></script>
	...
	<script type="text/javascript" src="<?php bloginfo('template_url'); ?>/javascript/classie.js"></script>
	<script>
	    (function() {
